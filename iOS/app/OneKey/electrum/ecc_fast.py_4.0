...
def load_library():
    ...
    for libpath in library_paths:
        try:
            ...
            break
    if not secp256k1:
        _logger.warning(f'libsecp256k1 library failed to load. exceptions: {repr(exceptions)}')
        return None
    ...
    try:
        ...
        _logger.warning(f'libsecp256k1 library was found and loaded but there was an error when using it: {repr(e)}')
        return None
