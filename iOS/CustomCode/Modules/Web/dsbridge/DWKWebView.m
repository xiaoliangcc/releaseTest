...
- (void) addJavascriptObject:(id)object namespace:(NSString *)namespaces{
    if(namespaces==nil){
      namespaces=@"";
    }
    if(object!=NULL){
        [javaScriptNamespaceInterfaces setObject:object forKey:namespaces];
    }
}

- (void) removeJavascriptObject:(NSString *)namespaces {
    if(namespaces==nil){
        namespaces=@"";
    }
    [javaScriptNamespaceInterfaces removeObjectForKey:namespaces];
}
